...
4. **CSV Summary Generator – File reading, writing and object list processing** – [Solution](https://github.com/joaopcarmo/JavaExercises/tree/main/Exercicios/Files/Fixacao/src)
5. **Employee Payment System – Inheritance and Polymorphism** - [Solution](https://github.com/joaopcarmo/JavaExercises/tree/main/Exercicios/Poo/src/Polimorfismo/Exercicio1)
6. **Bank System – Inheritance, Polymorphism, Upcasting and Downcasting** - [Solution](https://github.com/joaopcarmo/JavaExercises/tree/main/Exercicios/Poo/src/Heranca)
7. **Tax Calculation for Individuals and Companies Using Inheritance and Polymorphism** - [Solution](https://github.com/joaopcarmo/JavaExercises/tree/main/Exercicios/Poo/src/Polimorfismo/FixacaoAbstracao)
8. **Worker Contracts & Monthly Income Calculation** – [Solution](https://github.com/joaopcarmo/JavaExercises/tree/main/Exercicios/Composicao/src)
9. **Student Room Rental Management** – [Solution](https://github.com/joaopcarmo/JavaExercises/tree/main/Exercicios/Vetores/FixacaoHotel)
10. **Bank Account Operations: Withdrawal with Limit Validation - Exceptions** - [Solution](https://github.com/joaopcarmo/JavaExercises/tree/main/Exercicios/ExceptionsEx/FixacaoException/src)
11. **Currency Converter with IOF Tax** – [Solution](https://github.com/joaopcarmo/JavaExercises/tree/main/Exercicios/Poo/src/ExerciciosPoo/ConversorMoeda)
12. **Geometric Shape Area Calculation Using Inheritance and Polymorphism** – [Solution](https://github.com/joaopcarmo/JavaExercises/tree/main/Exercicios/Poo/src/Polimorfismo/ExercicioAbstracao)
13. **Salary Raise Calculator** – [Solution](https://github.com/joaopcarmo/JavaExercises/tree/main/Exercicios/Poo/src/ExerciciosPoo/SalarioFuncionario)  
14. **Bank Account Operations: Deposits and Withdrawals with Fee (Encapsulation)** – [Solution](https://github.com/joaopcarmo/JavaExercises/tree/main/Exercicios/Poo/src/ExerciciosPoo/ContaBancaria)  
15. **Final Grade Calculation and Approval Check** – [Solution](https://github.com/joaopcarmo/JavaExercises/tree/main/Exercicios/Poo/src/ExerciciosPoo/CalculoNota)  
